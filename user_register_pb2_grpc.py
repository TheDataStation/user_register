...
import user_register_pb2 as user__register__pb2


class UserRegisterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateUser = channel.unary_unary(
                '/client_interface.UserRegister/CreateUser',
...
def add_UserRegisterServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'client_interface.UserRegister', rpc_method_handlers)
